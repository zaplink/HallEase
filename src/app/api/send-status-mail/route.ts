		...
		<body>
			<div class="container">
				...
				<div class="details">
					...
					${status === 'rejected' && rejectReason ? `<div class="details-row"><span class="label">Rejection Reason:</span> <span class="value">${rejectReason}</span></div>` : ''}
				</div>
...
export async function POST(req: NextRequest) {
	try {
		...
		// Optionally require rejectReason if status is rejected
